...
use App\PagePartsBundle\Entity\Link;
...
class LinkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppPagePartsBundle:Link')->findAll();
     ...
     * @Method("POST")
     * @Template("AppPagePartsBundle:Link:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_link_show', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(Link $entity)
    {
        $form = $this->createForm(new LinkType(), $entity, array(
            'action' => $this->generateUrl('admin_link_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppPagePartsBundle:Link')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new LinkType(), $entity, array(
            'action' => $this->generateUrl('admin_link_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("AppPagePartsBundle:Link:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_link_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_link'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_link_delete', array('id' => $id)))
            ->setMethod('DELETE')

...
use App\PagePartsBundle\Entity\Text;
...
class TextController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppPagePartsBundle:Text')->findAll();
     ...
     * @Method("POST")
     * @Template("AppPagePartsBundle:Text:new.html.twig")
     */
    ...
    */
    private function createCreateForm(Text $entity)
    {
        $form = $this->createForm(new TextType(), $entity, array(
            'action' => $this->generateUrl('admin_text_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppPagePartsBundle:Text')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new TextType(), $entity, array(
            'action' => $this->generateUrl('admin_text_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("AppPagePartsBundle:Text:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_text_delete', array('id' => $id)))
            ->setMethod('DELETE')
